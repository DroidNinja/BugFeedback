...
import com.droidninja.feedback.utils.Matrix3;
...
public abstract class StickerTask extends AsyncTask<Bitmap, Void, Bitmap> {
    ...
    protected WeakReference<ImageEditorActivity> mContext;

    public StickerTask(WeakReference<ImageEditorActivity> activity) {
    ...
    protected void onPreExecute() {
        ...
        dialog = mContext.get().getLoadingDialog(mContext.get(), R.string.saving_image,
                false);
        dialog.show();
    }
    ...
    protected Bitmap doInBackground(Bitmap... params) {
        ...
        Matrix touchMatrix = mContext.get().imageView.getImageViewMatrix();
